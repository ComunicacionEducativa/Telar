...
function Tutorial(){
  return(<div>
    ...
    <p><b>Ejemplo 2:</b> El jugador 1 elige un color o diseño, y coloca <b>todas</b> las fichas del color o diseño que eligió en la parte superior de su telar, haciendo primero click sobre la ficha, y luego otro click en el lugar del telar en que se desea colocarla. En el ejemplo 2, el jugador 1 seleccionó tres fichas con el mismo diseño.  </p>
